<?php require_once 'cfg.php' ; if (!$user->isLogged()) {
...
<body>
    ...
    <div class="user-profile shadow">
        ...
        <div class="details">
            <img src='pfp/<?php echo $user->getAvatar()?>' id='avatar' class="avatar" alt="profile">
            ...
            <!-- <span class="font">Obecnie odtwarzane</span>
            <div class="spotify selected" onclick="getCurrentlyPlaying();">
                123
        ...
        <div class="settings ">
            ...
            <!-- <div class="setting selected">
                <i class="set-icon fa-solid fa-lock fa-xl"></i>
