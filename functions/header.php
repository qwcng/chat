<div class="main ">
    <div class="profile ">
        <img class="mypfp" src="pfp/<?php echo $user->getAvatar() ?>" alt="Profile Picture">
    ...
    <div class="friends" id="friends">
        ...
        <div class="setting  selected">
            <a href='profile.php' style='text-decoration:none; margin: auto 10px; '>
                <div class="avatar"><i class="fa-solid fa-user fa-2xl" style="color:white"></i></div>
                <div class='nick r font'>Mój profil</div>
            </a>
        </div>
        <div class="setting  selected ">
