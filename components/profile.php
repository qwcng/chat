<div class="user-profile shadow " style="height: 100dvh;">
    <i onclick="info()" class="fa-solid fa-arrow-left fa-xl" style="color: #ffffff; position:absolute; left:-20px; margin:10px auto;
            z-index:300;"></i>
    ...
    <div class="details">
        <img src='pfp/<?php echo $user->getAvatar($_GET['id'])?>' id='avatar' class="avatar" alt="profile">
    ...
    <div class="settings ">
        ...
        <div class="setting shadow">
            <i class="fa-solid fa-arrow-left fa-xl left" style="color: #ffffff;"></i>
            <span class="font label"></span>
            <i class="fa-solid fa-arrow-right fa-xl right" style="color: #ffffff;"></i>
        </div>
